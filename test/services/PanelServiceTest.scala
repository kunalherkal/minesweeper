...
class PanelServiceTest extends FunSpec {
  ...
  describe("method process") {
    val grid = Array(
      Array(Cell(" ",0,0,true), Cell(" ",0,1,true), Cell(" ",0,2,true), Cell("1",0,3,true), Cell("1",0,4,true), Cell("1",0,5,true), Cell(" ",0,6,true), Cell(" ",0,7,true), Cell(" ",0,8,true)),
      Array(Cell("1",1,0,true), Cell("1",1,1,true), Cell("2",1,2,true), Cell("2",1,3,true), Cell("*",1,4,true), Cell("1",1,5,true), Cell(" ",1,6,true), Cell(" ",1,7,true), Cell(" ",1,8,true)),
      Array(Cell("1",2,0,true), Cell("*",2,1,true), Cell("2",2,2,true), Cell("*",2,3,true), Cell("3",2,4,true), Cell("2",2,5,true), Cell("1",2,6,true), Cell(" ",2,7,true), Cell(" ",2,8,true)),
      Array(Cell("2",3,0,true), Cell("2",3,1,true), Cell("2",3,2,true), Cell("1",3,3,true), Cell("2",3,4,true), Cell("*",3,5,true), Cell("1",3,6,true), Cell("1",3,7,true), Cell("1",3,8,true)),
      Array(Cell("*",4,0,true), Cell("1",4,1,true), Cell(" ",4,2,true), Cell(" ",4,3,true), Cell("2",4,4,true), Cell("2",4,5,true), Cell("3",4,6,true), Cell("*",4,7,true), Cell("1",4,8,true)),
      Array(Cell("1",5,0,true), Cell("1",5,1,true), Cell(" ",5,2,true), Cell(" ",5,3,true), Cell("1",5,4,true), Cell("*",5,5,true), Cell("2",5,6,true), Cell("2",5,7,true), Cell("2",5,8,true)),
      Array(Cell("1",6,0,true), Cell("1",6,1,true), Cell("1",6,2,true), Cell(" ",6,3,true), Cell("1",6,4,true), Cell("2",6,5,true), Cell("2",6,6,true), Cell("2",6,7,true), Cell("*",6,8,true)),
